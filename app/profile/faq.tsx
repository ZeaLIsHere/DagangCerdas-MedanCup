    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <View style={styles.contentHeader}>
          ...
          <Text style={styles.subtitle}>Temukan jawaban untuk pertanyaan yang paling sering ditanyakan oleh pengguna DagangCerdas di bawah ini.</Text>
        </View>
          ...
          {FAQS.map((faq, index) => {
            ...
            return (
              <View key={index} style={styles.faqCard}>
                ...
                >
                  <Text style={[styles.questionText, isExpanded && styles.questionTextActive]}>{faq.question}</Text>
                  <Ionicons
        ...
        <View style={styles.supportContainer}>
          ...
          <Text style={styles.supportSubtitle}>Tim kami siap membantu Anda menyelesaikan kendala kapan saja.</Text>
